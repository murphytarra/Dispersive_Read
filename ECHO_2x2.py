...
class ECHO_2x2:
    def __init__(self, k1 = 10e-3, k2 = 10e-3, gc = 0.1, w = 0.01, w0 = 0.0101, delta = 1, gamma = 0.1, T = 0.1, H= [], Z = []):
    ...
    def Sz(self, B, e):
        return np.array([[0, self.delta], [self.delta, -e]])
    ...
    def evaluate(self,B, e): 
        ...
        eigvec2 = [eigvec[ind1[0]], eigvec[ind2[0]]]
    ...
    def run(self, Bmin= 0 , Bmax=5, emin=-3, emax=3, N = 150, save = False):
        ...
        for B in B1:
            for e in e1:
                [S11, phase, p0, p1] =  self.evaluate(B,e)
                z.append(S11)
                ph.append(phase)
